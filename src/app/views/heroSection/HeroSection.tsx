...
const Hero = () => {
  return (
    <div className='flex flex-col md:flex-row items-center justify-between pl-[100px] pt-[90px] bg-[#E0F8F2] '>
      <div className='  w-[779px] h-[500px] '>
      ...
      <div className='mt-8 md:mt-0 relative  overflow-hidden'>
        <img src='/svgs/hero/sidepic.svg' alt='Hero' className='absolute top-0 left-0 w-full z-10' />
        <img src='/svgs/hero/befindpic.svg' alt='Hero' className='w-full' />
      </div>
    </div>
  );
};
